...
> Showing the results' dependence on the value of beta is a great idea, and I have added several analyses along these lines in Figure 4C and Appendix 5.  In particular, I now show how CI coverage and the probability that the model will predict the wrong sign for an interaction vary as a function of beta (in addition to global estimates of R-squared and Type I error rates).  If you think that readers would benefit from even more disaggregation, I could include a data file containing the seven models' estimates for all the species pairs across all 450 simulated landscapes as a sixth Appendix.
...
>This line (65-66) now describes "how... conditional relationships can determine species composition" rather than referring to "groups".
