...
here have unimodal likelihood surfaces [@murphy_machine_2012], so these
estimates will represent the global optimum. 
...
per-capita basis in these simulations. To prevent runaway mutualisms leading to
...
and scale 2) ensured that the estimates were always finite (Appendix 2).
...
4). The Markov network's errors were also more concentrated around 0, and it 
