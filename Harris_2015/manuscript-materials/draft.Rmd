...
correct identification of the negative shrub-shrub interaction (circled).](figures/Figure_1.pdf)
...
increase its occurrence rate and the co-occurrence deficit would be eliminated.](figures/Figure_2.pdf)
...
vectors of those same species and from the number of sites on the landscape.](figures/performance.pdf)
