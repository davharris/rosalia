...
gradients; the package passes these functions to the "BFGS" method in R's
general-purpose optimizer, which then estimates the Markov network parameters.
...
overall measure of their relationship.
