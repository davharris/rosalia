...
shown in Appendix 5, the standard errors associated with the estimates in Figure
...
twice as often overall (Appendix 5).  The Markov network's errors were also
