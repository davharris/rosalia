...
combination of size and model). As described in Appendix 2, I randomly drew
...
the population dynamics of 20 interacting species, as described in Appendix 3.
...
model estimates were always finite.
