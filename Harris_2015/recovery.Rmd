...
fit_all = function(identifier){
  ...
  n_spp = as.integer(splitname[[1]]) # simulated species, NOT present species
  n_sites = as.integer(splitname[[2]])
  rep_name = splitname[[3]]
  ...
  ######## Markov network ########
  rosie = rosalia(x, maxit = 200, trace = 0, prior = make_logistic_prior(scale = 2), hessian = TRUE)
