...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{z$}\StringTok{`}\DataTypeTok{-Pairs}\StringTok{`} \NormalTok{=}\StringTok{ }\NormalTok{-z$Pairs}
...
\StringTok{  }\KeywordTok{stat_abline}\NormalTok{(}\DataTypeTok{intercept =} \DecValTok{0}\NormalTok{, }\DataTypeTok{slope =} \KeywordTok{coef}\NormalTok{(}\KeywordTok{lm}\NormalTok{(z$truth ~}\StringTok{ }\NormalTok{z$}\StringTok{`}\DataTypeTok{-Pairs}\StringTok{`} \NormalTok{+}\StringTok{ }\DecValTok{0}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
